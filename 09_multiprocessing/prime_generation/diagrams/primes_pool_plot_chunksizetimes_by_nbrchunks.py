...
if __name__ == "__main__":
    ...
    filename = "primes_pool_plot_chunksizetimes_by_nbrchunks{}.pickle".format(shuffle_in_filename)
    png_filename = "08_primes_pool_plot_chunksizetimes_by_nbrchunks_sawtoothpattern{}.png".format(shuffle_in_filename)
    ...
    if args.create_data:
        ...
        cPickle.dump((nbr_chunks_per_trial, time_per_chunksize, NBR_PROCESSES, number_range), open(filename, 'wb'))
    else:
