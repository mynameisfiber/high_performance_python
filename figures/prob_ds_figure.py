...
import sys, os
sys.path.append(os.path.abspath("../11_less_ram/probabilistic_datastructures/"))
...
if __name__ == "__main__":
    ...
    run_experiment("60000 elements with duplicates", "dup", generate_keys(60000, 3), methods)
    py.show()
